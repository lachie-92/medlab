                                    ...
                                    <div class="medlab_product_list_main_shopping_box">
                                        ...
                                        @if ($product->in_stock)
                                            <form action="/shoppingcart/update" method="post">
                                                ...
                                                <button class="btn btn-sm medlab_product_list_main_shopping_box_button_add" product="{{ $product->id }}" title="Add to Cart" type="submit">
                                        ...
                                        <button class="btn btn-info btn-sm medlab_product_list_main_shopping_box_button_info" product="{{ $product->id }}" onClick="location.href='/nutraceuticals/products/{{ $product->slug }}'">
                                            Learn More
                                        </button>
                                    </div>
                                </div>
