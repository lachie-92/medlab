        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-primary medlab_panel">
                ...
                <div class="panel-body medlab_panel_content">
                    ...
                    <ul>
                        <li>A highly focused laser passes through a liquid dispersion in a specially designed cell. </li>
                        <li>As the nanoparticles in the dispersion interact with the laser, they are observed as points of light moving under Brownian motion through a microscope.</li>
                        <li>The rate at which the particles move is a function of their diffusional rate, which is in turn a function of their size as given by the Stokes-Einstein equation.</li>
                        <li>By tracking the motion of each particle over a specified amount of time, the diffusional rate can be measured and the particle size calculated.</li>
                        <li>Since the cell is a known volume and the particles present are individually counted, an accurate particle concentration can be calculated simultaneously. </li>
                    </ul>
                    <p style="text-align: justify;">
                    ...
                    <ul>
                        <li>aggregated proteins</li>
                        <li>pigment components</li>
                        <li>micelles</li>
                        <li>emulsion droplets suspended in a continuous phase</li>
                    </ul>
                    <p style="text-align: justify;">
                        DLS technlogy employs the following steps:
                    </p>
                    <ul>
                        <li>The nano-dispersed system is placed into the optical path of a LASER.</li>
                        <li>The LASER is then scattered upon interacting with the particles in the suspension, which are moving by Brownian motion.</li>
                        <li>The scattered light is captured by a detector over the course of the analysis to determine the rate of diffusion (i.e. how fast the particles move within a system due to Brownian motion). </li>
                        <li>The average hydrodynamic particle size (referred to as the Z-Average) is calculated on an intensity-weighted basis using the Stokes-Einstein equation.  </li>
                    </ul>
                    <p style="text-align: justify;">
