                    ...
                    <div class="medlab_news_item">
                        <div class="medlab_news_item_content_wrapper">
                            <div class="medlab_news_item_title">
                                Understanding the Clinical Applications of NanoCelle<sup>™</sup>
                            </div>
                            <div class="medlab_news_item_body">
                                <div class="media-middle media-middle">
                                    <iframe src="https://player.vimeo.com/video/205989701" width=100% height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
