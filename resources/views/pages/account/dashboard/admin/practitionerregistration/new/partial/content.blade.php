                                        ...
                                        <div id="create_clinic_box" class="collapse">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <table style="width:100%;">
                                                        <tr><th class="medlab_registration_form_section_subtitle">Suburb<span style="color: red;">*</span></th></tr>
                                                        <tr><td><input id="create_new_street_address_two" type="text" class="form-control" name="create_new_street_address_two" placeholder="Suburb" value="{{ $registration->suburb }}"></td></tr>
                                                    </table>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <table style="width:100%;">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                {!! Form::select('create_new_country', $country, old('create_new_country', $registration->country), ['class' => 'form-control', 'id' => 'create_new_country_select', 'data-change-state' => 'create_new_state_select']) !!}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
