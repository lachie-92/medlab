...
<div class="medlab_breadcrumbs_wrapper">
    <div class="container">
        <ol class="breadcrumb medlab_breadcrumbs">
            ...
            <li><a class="medlab_breadcrumbs_link" href="/account/practitioner-registration">Practitioner Registration</a></li>
            <li class="active medlab_breadcrumbs_text">Approved Registration</li>
        </ol>
    </div>
</div>
