...
<div class="row">
    <form action="{{ route('account.patient-history.update', $history->id) }}" method="POST" id="patient-history">
        ...
        <input type="hidden" name="page" value="3"> @endif
                                        ...
                                        <div class="col-md-1 col-sm-1">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-1 col-sm-1 ">
                                                    ...
                                                    <input type="checkbox " id="_past30_throat_jawpain " class="shadowCheckbox " name="_past30_throat_jawpain " {{ array_get($intake, 'past30_throat_jawpain')=="1 "?'checked="checked
                                            "':'' }} {{ isset($readOnly)?'disabled="disabled "':'' }} />
                                                </div>
                                                <div class="col-md-3 col-sm-3 ">
                                                ...
                                                <div class="col-md-1 col-sm-1 ">
                                                    ...
                                                    <input type="checkbox " id="_past30_skin_colorchangehandsfeet " class="shadowCheckbox " name="_past30_skin_colorchangehandsfeet " {{ array_get($intake, 'past30_skin_colorchangehandsfeet')=="1
                                            "?'checked="checked "':'' }} {{ isset($readOnly)?'disabled="disabled "':'' }} />
                                                </div>
                                                <div class="col-md-3 col-sm-3 ">
