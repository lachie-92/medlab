...
<footer class="footer">
    <div class="medlab_footer_top_wrapper">
        <div class="container medlab_footer_top_container">
            <div class="row medlab_footer_top_site_map_box">
                <div class="col-md-3 col-sm-3 col-xs-6">
                    ...
                    <ul class="medlab_footer_top_site_map_box_list">
                        ...
                        <li>
                            <a class="medlab_footer_top_site_map_box_link" href="/nutraceuticals/categories">View by Categories</a>
                        </li>
                        <li>
...
<footer class="footer">
    <div class="medlab_footer_bottom_wrapper">
        <div class="container medlab_footer_bottom_container">
            ...
            <div class="row medlab_footer_bottom_contact_info_box">
                <div class="col-md-3 col-sm-3 col-xs-6">
