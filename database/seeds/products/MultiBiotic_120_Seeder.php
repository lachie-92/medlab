...
class MultiBiotic_120s_Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        Product::create([
            ...
            'xero_item_id' => 4,
            'product_name_index' => "MultiBiotic 120's",
            'product_name' => 'MultiBiotic 120&#39;s',
            'short_description' =>
                '
                <h4 class="medlab_product_content_title">MultiBiotic 120&#39;s</h4>
                <p>
            ...
            'dosage_information' =>
                ...
                <div style="text-align: center">
                    <img src="/img/products/multibiotic_120s/2partcap_4_3_1_2.png">
                </div>
                ',
            'ingredients' =>
                '
