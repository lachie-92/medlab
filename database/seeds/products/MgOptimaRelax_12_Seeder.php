...
class MgOptimaRelax_12_Seeder extends Seeder
{
    /**
        ...
        Product::create([
            ...
            'cmi' =>
                ...
                <p>
                    ...
                    <a class="medlab_panel_content_link"href="https://s3.amazonaws.com/medlab-pdfs/mg-optima/English.pdf">
                        Click Here For English CMI
                    </a>
                </p>
                <p>
                    <img width="24" height="24" alt="Saudi Arabia" src="/img/products/cmi/Saudi-Arabia.png">
                    <a class="medlab_panel_content_link" href="https://s3.amazonaws.com/medlab-pdfs/mg-optima/Arabic.pdf">الترجمة العربية </a>
                </p>
                <p>
                    <img width="24" height="24" alt="Russia" src="/img/products/cmi/Russia.png">
                    <a class="medlab_panel_content_link" href="https://s3.amazonaws.com/medlab-pdfs/mg-optima/Russian.pdf">Перевод на русском языке</a>
                </p>
                <p>
                ...
                <p>
                    ...
                    <a class="medlab_panel_content_link" href="https://s3.amazonaws.com/medlab-pdfs/mg-optima/Japanese.pdf">日本語翻訳</a>
                </p>
                <p>
                    <img width="24" height="24" alt="France" src="/img/products/cmi/France.png">
                    <a class="medlab_panel_content_link" href="https://s3.amazonaws.com/medlab-pdfs/mg-optima/French.pdf">Traduction en français</a>
                </p>
                <p>
                    <img width="24" height="24" alt="China" src="/img/products/cmi/China.png">
                    <a class="medlab_panel_content_link" href="https://s3.amazonaws.com/medlab-pdfs/mg-optima/Chinese.pdf">中文翻译，中文翻譯</a>
                </p>
                ',
            'free_from' =>
                '
