...
class PaymentVisaCardResponseCodeTestCest
{
    //
    // Card Details
    //
    protected $cardNumber = '4987654321098769';
    ...
    public function invokeVisaCardResponseCode0(AcceptanceTester $I)
    {
    ...
    public function invokeVisaCardResponseCode1(AcceptanceTester $I)
    {
    ...
    public function invokeVisaCardResponseCode2(AcceptanceTester $I)
    {
    ...
    public function invokeVisaCardResponseCode4(AcceptanceTester $I)
    {
    ...
    public function invokeVisaCardResponseCode5(AcceptanceTester $I)
    {
    ...
    public function invokeVisaCardResponseCodeE(AcceptanceTester $I)
    {
    ...
    public function invokeVisaCardCSCResultCodeP(AcceptanceTester $I)
    {
        $testProduct = $this->getTestProductReady($I, $this->response0Trigger);
        $this->getShoppingCartReady($I, $testProduct);
    ...
    public function invokeVisaCardCSCResultCodeN(AcceptanceTester $I)
    {
        $testProduct = $this->getTestProductReady($I, $this->response0Trigger);
        $this->getShoppingCartReady($I, $testProduct);
